...
curl --insecure -X POST -d @new_story.xml https://www3.v1host.com/CoxMediaGroup61/rest-1.v1/Data/Story --header "Content-Type:text/xml" -H 'Authorization:Bearer 1.3oUG4h32Yu5FM7GcgWGxjYIHfcU='
